...
<!-- Favicons -->
<link rel="shortcut icon" href="6.png" sizes="180x180">
...
<body>
		...
		<div class="col-md-4 text-end">
			...
			<c:if test="${id!=null }">
				<form name="loginokay" method="post">
      			${id }님, 안녕하세요!
					<input type="button" class="btn btn-dark" onclick="mypage()" value="마이페이지"> 
					<input type="button" class="btn btn-outline-dark me-2" onclick="logout()" value="로그아웃">
				</form>
			</c:if>
		</div>
	</header>
	...
	<footer
		...
		<div class="col-md-4 d-flex align-items-center bg-dark">
			<a href="/"
				class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
			</a> <span class="mb-3 mb-md-0 text-muted">&copy; All100Shoes.inc</span>
		</div>
	</footer>
